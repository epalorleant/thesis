...
% 
 ...
 \titleformat{\chapter}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
     ...
     \node[yshift=-7cm] at (current page.north west)
       {\begin{tikzpicture}[remember picture, overlay]
         \draw[fill=blue] (0,0) rectangle(35.5mm,15mm);
         \node[anchor=north east,yshift=-6.2cm,xshift=34mm,minimum height=30mm,inner sep=0mm] at (current page.north west)
         ...
         \node[anchor=north west,yshift=-6.2cm,xshift=37mm,text width=\textwidth,minimum height=30mm,inner sep=0mm] at (current page.north west)
               {\parbox[top][30mm][t]{\textwidth}{\color{black}#1}};			%boîte qui contient le paramètre passé: le titre
        \end{tikzpicture}
       };
    \end{tikzpicture}
    \gdef\chapterlabel{}
