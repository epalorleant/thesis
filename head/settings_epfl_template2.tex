...
% 
 ...
 \titleformat{\chapter}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
     ...
     \node[yshift=-8cm] at (current page.north west)
       {\begin{tikzpicture}[remember picture, overlay]
         \draw[fill=blue] (0,0) rectangle(55.5mm,15mm);
         \node[yshift=-7.2cm,xshift=54mm,minimum height=30mm,inner sep=0mm] at (current page.north west)
         ...
         \node[anchor=north west,yshift=-7.2cm,xshift=57mm,text width=\textwidth,minimum height=30mm,inner sep=0mm] at (current page.north west)
